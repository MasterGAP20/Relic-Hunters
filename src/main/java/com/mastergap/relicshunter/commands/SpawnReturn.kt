...
class SpawnReturn : CommandExecutor{
    ...
    override fun onCommand(sender: CommandSender, command: Command, label: String, args: Array<out String>): Boolean {
        ...
        seller.customName(Component.text("Return to the Dungeon", Style.style(TextColor.fromHexString("#ffbf2b"))))
        seller.isCustomNameVisible = true
        seller.addScoreboardTag("return")
        seller.setAI(false)
        return true
    }
}